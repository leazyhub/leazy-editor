...
export const UniqueId = Extension.create<UniqueIdOptions>({
  ...
  addOptions() {
    return {
      attributeName: 'id',
      name: 'detailsSummary',
      types: ['blockContainer', 'paragraph', 'heading', 'details', 'detailsSummary', 'detailsContent', 'listItem', 'list', 'alert', 'blockquote', 'codeBlock', 'table', 'tableRow', 'tableCell', 'horizontalRule', 'image', 'video', 'audio', 'embed', 'link', 'listItem', 'list', 'orderedList', 'bulletList', 'code', 'twitter', 'lesson', 'bold', 'underline', 'italic', 'color', 'highlight', 'textStyle', 'fontSize'],
      generateID: () => nanoid(),
      injectNodeName: true
    }
  },
